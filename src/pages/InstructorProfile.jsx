    ...
    const fetchData = async () => {
      try {
        const [instructorRes, coursesRes, statsRes] = await Promise.all([
          axios.get(`https://wisdomize-backend.onrender.com/api/users/instructors/${email}`),
          axios.get(`https://wisdomize-backend.onrender.com/api/courses/instructor/${email}`),
          axios.get(`https://wisdomize-backend.onrender.com/api/reviews/instructor/${email}`)
        ]);
