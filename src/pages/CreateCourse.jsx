...
const CreateCourse = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('https://wisdomize-backend.onrender.com/api/categories');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://wisdomize-backend.onrender.com/api/courses', formData, {
        headers: {
