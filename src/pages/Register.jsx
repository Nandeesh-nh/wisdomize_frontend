...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://wisdomize-backend.onrender.com/api/auth/register", formData);
  ...
  return (
    <div className="mt-4 mb-4 min-h-screen flex items-center justify-center bg-gray-950 text-white">
