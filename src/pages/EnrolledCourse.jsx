...
const EnrolledCourse = () => {
  ...
  useEffect(() => {
    ...
    const fetchCourse = async () => {
      try {
        const res = await axios.get(`https://wisdomize-backend.onrender.com/api/courses/${enrolledCourseId}`, {
    ...
    const fetchVideos = async () => {
      try {
        const res = await axios.get(`https://wisdomize-backend.onrender.com/api/course-videos/${enrolledCourseId}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
        setVideos(res.data);
      } catch (err) {
    ...
    const fetchReviews = async () => {
      try {
        const res = await axios.get(`https://wisdomize-backend.onrender.com/api/reviews/${enrolledCourseId}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
        setReviews(res.data);
  ...
  const handleReviewSubmit = async () => {
    ...
    try {
      await axios.post("https://wisdomize-backend.onrender.com/api/reviews", {
