  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const coursesResponse = await axios.get('https://wisdomize-backend.onrender.com/api/courses', {
          headers: { Authorization: `Bearer ${token}` }
        });
        setCourses(coursesResponse.data);

        // Fetch categories
        const categoriesResponse = await axios.get('https://wisdomize-backend.onrender.com/api/categories', {
          headers: { Authorization: `Bearer ${token}` }
        });
